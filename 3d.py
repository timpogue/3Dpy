...
if __name__ == "__main__":
    ...
    bullet = AnimatedWireframe()
    sphere = sphere((200, 200, 0), (100, 100, 100), 24)

    bullet.nodes = sphere.nodes
    bullet.edges = sphere.edges
    bullet.faces = sphere.faces

    camera.addWireframe("bullet", bullet)
    camera.run()
